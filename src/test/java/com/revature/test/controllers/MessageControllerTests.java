...
public void testCreateMessage() throws Exception {
	...
	when(service.create(mockMessageCreation)).thenReturn(true);
...
public void testGetById() throws Exception {
	when(service.findById(1)).thenReturn(mockMessage1);
...
public void testUpdateMessage() throws Exception {
	when(service.update(mockMessageModification)).thenReturn(true);
